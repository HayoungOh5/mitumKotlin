...
fun main() {
    // insert publickey and privatekey
    val pubkey = "02a0d34b9b8657f31d4aca55d50f21e64636a6625a3a60f122333c5677acb5bb34fpu"
    ...
    val signedOperation = accSign(pubkey, privatekey, operation)
